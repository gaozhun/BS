...
from DRAEM_CBAM_MOB.model import ReconstructiveSubNetwork, DiscriminativeSubNetwork
import os
...
def test(obj_names, mvtec_path, checkpoint_path, base_model_name):
    ...
    for obj_name in obj_names:
        ...
        visualizer = TensorboardVisualizer(log_dir=os.path.join("./visualizer", run_name+"/"))
        ...
        for i_batch, sample_batched in enumerate(dataloader):
            ...
            visualizer.visualize_image_batch(display_gt_images, cnt_display, image_name='display_gt_images')
            visualizer.visualize_image_batch(display_images, cnt_display, image_name='display_images')
            visualizer.visualize_image_batch(display_out_masks, cnt_display, image_name='display_out_masks')
            visualizer.visualize_image_batch(display_in_masks, cnt_display, image_name='display_in_masks')
